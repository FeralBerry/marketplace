import {imgLinks} from "./Variable.tsx"
                                                ...
                                                <div className="cart-content-wraper">
                                                    <div className="cart-single-wraper">
                                                        <div className="cart-img">
                                                            <a href="#"><img src={imgLinks + "/product/01.jpg"} alt=""/></a>
                                                        </div>
                                                    ...
                                                    <div className="cart-single-wraper">
                                                        <div className="cart-img">
                                                            <a href="#"><img src={imgLinks + "/product/02.jpg"} alt=""/></a>
                                                        </div>
                                                        <div className="cart-content">
                                                            <div className="cart-name"><a href="#">Aenean Eu
                                                                Tristique</a></div>
                        ...
                        <div className="full-width-mega-dropdown">
                            <div className="row">
                                <div className="col-md-2 col-sm-2">
                                    <div className="logo ptb-20"><a href="/"> <img src={imgLinks + "/logo/logo.png"}
                                                                                            alt="main logo"/></a></div>
                                </div>
                                <div className="col-md-7 col-sm-10 hidden-xs">
                                    <nav id="primary-menu">
                                        <ul className="main-menu">
                                            <li className="current"><a className="active" href="index.html">Home</a>
